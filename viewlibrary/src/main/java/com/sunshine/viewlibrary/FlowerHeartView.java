...
public class FlowerHeartView extends View {
...
//        }
    ...
    public FlowerHeartView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FlowerHeartView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        particleSystem = new ParticleSystem(10, 500, 300, 100);
        ...
        leftPath.moveTo(mWidth / 2, mHeight / 4);
        leftPath.cubicTo((mWidth * 6) / 7, mHeight / 9, (mWidth * 12) / 13, (mHeight * 2) / 5, mWidth / 2, (mHeight * 7) / 12);


        rightPath.moveTo(mWidth / 2, mHeight / 4);
        rightPath.cubicTo(mWidth / 7, mHeight / 9, mWidth / 13, (mHeight * 2) / 5, mWidth / 2, (mHeight * 7) / 12);
